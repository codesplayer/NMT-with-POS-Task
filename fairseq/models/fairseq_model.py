...
class BaseFairseqModel(nn.Module):
    ...
    def get_srcpos(self, sample, net_output):
        """Get targets from either the sample or the net's output."""
        return sample["net_input"]["src_pos"]

    def get_tarpos(self, sample, net_output):
        """Get targets from either the sample or the net's output."""
        return sample["tgtget_pos"]
...
class FairseqEncoderDecoderModel(BaseFairseqModel):
    ...
    def forward(self, src_tokens, src_pos, src_lengths, prev_output_tokens, prev_output_pos_tokens, **kwargs):
        """
