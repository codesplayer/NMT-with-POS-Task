...
def progress_bar(
    iterator, log_format: Optional[str] = None, log_interval: int = 100, epoch: Optional[int] = None,
    prefix: Optional[str] = None, tensorboard_logdir: Optional[str] = None, default_log_format: str = 'tqdm',):
...
class TqdmProgressBar(BaseProgressBar):
    ...
    def __init__(self, iterable, epoch=None, prefix=None):
        ...
        self.tqdm = tqdm(
            iterable, self.prefix, leave=False,  disable=(logger.getEffectiveLevel() > logging.INFO),)
