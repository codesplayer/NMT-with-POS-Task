...
def parse_args_and_arch(
    ...
    """
    #input_args = ['F:/fairseq7/save/bin']
...
def add_preprocess_args(parser):
    ...
    group.add_argument("--trainpref", metavar="FP", default="F:/fairseq7/save/data/dev.bpe",
                       help="train file prefix")
    group.add_argument("--trainpos", metavar="FP", default="F:/fairseq7/save/data/dev_pos",
                       help="train file prefix")
    group.add_argument("--validpref", metavar="FP", default="F:/fairseq7/save/data/dev.bpe",
                       help="comma separated, valid file prefixes")
    group.add_argument("--validpos", metavar="FP", default="F:/fairseq7/save/data/dev_pos",
                       help="train file prefix")
    group.add_argument("--testpref", metavar="FP", default="F:/fairseq7/save/data/dev.bpe",
                       help="comma separated, test file prefixes")
    group.add_argument("--testpos", metavar="FP", default="F:/fairseq7/save/data/dev_pos",
                       help="train file prefix")
    group.add_argument("--align-suffix", metavar="FP", default=None,
                       help="alignment file suffix")
    group.add_argument("--destdir", metavar="DIR", default="F:/fairseq7/save/bin",
    ...
    group.add_argument("--joined-dictionary", action="store_true", default=True,
...
def add_dataset_args(parser, train=False, gen=False):
    ...
    group.add_argument('--max-tokens', type=int, metavar='N', default=128,
...
def add_optimization_args(parser):
    ...
    group.add_argument('--update-freq', default='4', metavar='N1,N2,...,N_K',
                       type=lambda uf: eval_str_list(uf, type=int),
                       help='update parameters every N_i batches, when in epoch i')
    group.add_argument('--lr', '--learning-rate', default='0.0007', type=eval_str_list,
...
def add_checkpoint_args(parser):
    ...
    # fmt: off
    group.add_argument('--save-dir', metavar='DIR', default='F:/fairseq7/save/model/',
...
def add_common_eval_args(group):
    # fmt: off
    group.add_argument('--path', metavar='FILE', default="F:/fairseq7/save/model/checkpoint1.pt",
...
def add_model_args(parser):
    ...
    group.add_argument('--arch', '-a', metavar='ARCH', default="transformer_wmt_en_de",
